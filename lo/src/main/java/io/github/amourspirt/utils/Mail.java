  ...
  */
  {
    try {
      ...
      // final var created in this method were added to fix a bug. Cannot refer to the
      // non-final local variable offset defined in an enclosing scope
      final String mailhostF = mailhost;
      final int portF = port;
      XCurrentContext xcc = new XCurrentContext() {
        public Object getValueByName(String name)
        {
          if (name.equals("ServerName"))
            return (Object) mailhostF;
          else if (name.equals("Port"))
            return (Object) Integer.valueOf(portF);
