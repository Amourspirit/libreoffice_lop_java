package io.github.amourspirt.utils;
  ...
  */
  ...
  public static void displayResultSet(XResultSet rs, String title, int offset)
  {
    ...
    try {
      ...
      // the following three final lines were added to fix a bug. Cannot refer to the
      // non-final local variable offset defined in an enclosing scope
